...
final class StatisticsService {
    ...
    func fetchUsers(completion: @escaping (Result<[UsersModel], Error>) -> Void) {
        ...
        URLSession.shared.objectTaskStatisctic(for: request) { [weak self] (response: Result<[UsersResult], Error>) in
    ...
    func fetchNFTs(completion: @escaping (Result<[NFTModel], Error>) -> Void) {
        ...
        URLSession.shared.objectTaskStatisctic(for: request) { [weak self] (response: Result<[NFTResult], Error>) in
            guard let self = self else { return }
